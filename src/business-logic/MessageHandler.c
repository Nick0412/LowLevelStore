...
//     SizeAwareBuffer_Get32BitValue(incoming_message, )
//     SizeAwareBuffer_Get32BitValue(incoming_message, 4, &message_type_uint);
...
//     SizeAwareBuffer response_buffer = {
//         .raw_buffer = malloc(size_of_response_buffer),
...
//     free(response_buffer.raw_buffer);
// }
